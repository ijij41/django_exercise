...
from dash_board import views

urlpatterns = [

    url(r'^$', TemplateView.as_view(template_name='index.html'), name='main'),
    url(r'^flot/$', TemplateView.as_view(template_name='pages/flot.html'), name='flot'),

    url(r'^ajax/getGBarData/$', views.getGBarData, name='ajax_getGBarData'),
    #
    #
    #
